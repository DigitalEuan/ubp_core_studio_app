# **UBP Core Studio** 
is a specialized research environment designed for exploring the **Universal Binary Principle (UBP)**. 
It integrates a local Python kernel (Pyodide), advanced AI assistance (Gemini + Local LLMs), and a reflexive memory system to create a powerful, self-contained workspace for computational philosophy and scientific discovery.
...
### Updates to scripts and KB
*   Scripts in the Workspace **automatically download** from: [https://github.com/DigitalEuan/UBP_Repo/blob/main/core_studio_v4.0/core]
*   ubp_system_kb.json, hash_memory.kb.json and ubp_beliefs_kb.json **automatically download** from: [https://github.com/DigitalEuan/UBP_Repo/blob/main/core_studio_v4.0/system_kb/]
...
Simply access the deployed application URL. The entire environment runs within your web browser.

This contains everything you need to run your app locally.

View your app in AI Studio: https://ai.studio/apps/8eef816d-e338-4bcb-9ae0-b9d2d0c476a5
...
##  Made with:
<div align="center">
<img width="300" height="auto" alt="GHBanner" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />
</div>
